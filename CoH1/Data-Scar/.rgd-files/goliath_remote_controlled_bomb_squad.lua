...
GameData["squad_ui_ext"]["extra_text"] = "$108750" -- Good vs. Tanks, Buildings, Bridges.
GameData["squad_ui_ext"]["help_text"] = "$108752" -- A small remote controlled Bomb that can inflict massive area effect damage upon detonation.
GameData["squad_ui_ext"]["hotkey_name"] = [[axis_goliath]]
GameData["squad_ui_ext"]["icon_name"] = [[vehicles\vehicle_axis_golliath]]
GameData["squad_ui_ext"]["screen_name"] = "$108751" -- Goliath
