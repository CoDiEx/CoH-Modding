...
GameData["ability_bag"]["ui_info"]["extra_text"] = "$126903" -- Good vs. Tanks, Buildings
GameData["ability_bag"]["ui_info"]["help_text"] = "$126900" -- Goliaths are remote controlled Tanks packed with Explosives.
...
GameData["ability_bag"]["ui_info"]["screen_name"] = "$126901" -- Detonate the Goliath
...
GameData["ability_bag"]["ui_usage_txt"] = "$126902" -- Left-click icon to detonate the Goliath.
